...
<meta content="t0uFqtlTOKVzB7ddqsozWjTJfrD5eerrMZX8IZ79D0Q=" name="csrf-token" />
<script type="text/javascript">
//<![CDATA[
window.gon={};gon.default_issues_tracker="gitlab";gon.api_version="v3";gon.relative_url_root="";gon.default_avatar_url="http://git.evenhidata.com/assets/no_avatar-b04e3c91a2586395b6e7e9df2672fb64.png";gon.max_file_size=10;
//]]>
</script>
...
<img alt="Logo white" height="32" src="/assets/logo-white-8741ca66242e138fc2e3efead1e2d7c3.png" width="32" />
</div>
</div>
</header>
...
<form accept-charset="UTF-8" action="/users/sign_in" class="new_user" id="new_user" method="post"><div style="display:none"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="t0uFqtlTOKVzB7ddqsozWjTJfrD5eerrMZX8IZ79D0Q=" /></div><input autofocus="autofocus" class="form-control top" id="user_login" name="user[login]" placeholder="Username or Email" type="text" />
...
<div class='login-body'>
<form accept-charset="UTF-8" action="/users" class="new_user" id="new_user" method="post"><div style="display:none"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="t0uFqtlTOKVzB7ddqsozWjTJfrD5eerrMZX8IZ79D0Q=" /></div><div class='devise-errors'>
...
<h1>
<a id="eventhink" class="anchor" href="#eventhink" aria-hidden="true"></a>EVENTHINK</h1>
